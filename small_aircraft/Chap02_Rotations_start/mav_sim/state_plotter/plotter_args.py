...
class PlotArgs:
    ...
    '''
    def __init__(self, name: Optional[str] =None, states: Optional[list[str]] =None, sigma_bounds: list[int] =None,
                    is_angle: Optional[bool] =None, rad2deg: Optional[bool] =None, max_length: int =None,
                    connect: bool =True, symbol: Literal['o', 'd', '+', 't', 's'] ='o', symbol_size: float=2,
                    px_mode: bool =True, color: Optional[str]=None, hidden: bool =False) -> None:
