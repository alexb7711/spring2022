...
def main() -> None:
    ...
    sim_params = MsgSimParams(end_time=100., video_name="chap7.avi") # Sim ending in 10 seconds
    state = DynamicState()
    ...
    (mav_view, data_view, sensor_view) = run_sim(sim=sim_params, init_state=state, \
