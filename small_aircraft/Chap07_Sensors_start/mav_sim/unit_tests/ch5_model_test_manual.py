...
from mav_sim.chap5.compute_models import (
    compute_ss_model,
    compute_tf_model,
    df_du,
    df_dx,
...
trim_state = types.DynamicState( np.array([[0.000000, -0.000000, -100.000000, 24.968743,\
    0.000000, 1.249755, 0.999687, 0.000000, 0.025003, 0.000000, 0.000000, 0.000000, 0.000000]]).T )
...
f_euler_ = f_euler(x_euler_, trim_input)
print("f_euler_: \n" , f_euler_, "\n")

A_ = df_dx(x_euler_, trim_input)
print("A_: \n" , A_, "\n")

B_ = df_du(x_euler_, trim_input)
print("B_: \n" , B_, "\n")

dT_dVa_ =  dT_dVa(mav._Va, trim_input.throttle)
print("dT_dVa_: " , dT_dVa_, "\n")

dT_ddelta_t_ =  dT_ddelta_t(mav._Va, trim_input.throttle)
print("dT_ddelta_t_: " , dT_ddelta_t_, "\n\n\n")


new_state = types.DynamicState( np.array([[ 6.19506532e+01],
 [ 2.22940203e+01],
 [-1.10837551e+02],
 [ 2.73465947e+01],
 [ 6.19628233e-01],
...
f_euler_ = f_euler(x_euler_, delta)
print("f_euler_: \n" , f_euler_, "\n")

A_ = df_dx(x_euler_, delta)
print("A_: \n" , A_, "\n")

B_ = df_du(x_euler_, delta)
print("B_: \n" , B_, "\n")

dT_dVa_ =  dT_dVa(Va, delta.throttle)
print("dT_dVa_: " , dT_dVa_, "\n")

dT_ddelta_t_ =  dT_ddelta_t(Va, delta.throttle)
print("dT_ddelta_t_: " , dT_ddelta_t_, "\n")

# A_lon:
#  [[-0.20676658  0.50039026 -1.21983882 -9.78513443 -0.        ]
#  [-0.56064206 -4.46393561 24.37105023 -0.53883557 -0.        ]
...
# A_lat:
#  [[-7.76772566e-01  1.24975500e+00 -2.49687430e+01  9.78758394e+00
#    0.00000000e+00]
#  [-3.86671904e+00 -2.26288510e+01  1.09050409e+01  0.00000000e+00
#    0.00000000e+00]
#  [ 7.83077082e-01 -1.15091678e-01 -1.22765475e+00  0.00000000e+00
#    0.00000000e+00]
...
#        a_V1:  0.055243410440582306  ** current: 0.2817100013494606  -- I believe the current to be correct
#   due to original code improper use of the Va stored in the class

#        a_V2:  8.207220863813479

#        a_V3:  9.799999999999892 ** current: 9.809999999999892
...
#   -7.76772566e-01  6.37546449e-06  9.79757127e+00  0.00000000e+00
...
#    1.29189588e-13  0.00000000e+00  2.43710502e+01  0.00000000e+00]
#  [ 0.00000000e+00  0.00000000e+00  0.00000000e+00  0.00000000e+00
#    0.00000000e+00  0.00000000e+00  0.00000000e+00  0.00000000e+00
...
#   -3.86671904e+00  7.19895526e-03  0.00000000e+00  0.00000000e+00
...
#    7.83077082e-01  4.93778316e-04  0.00000000e+00  0.00000000e+00
...
# dT_dVa_:  0.13893420411221769 ** current: -2.3521982765206673 -- I belive new version is correct. Same explanation as before
...
#    1.67758476e-01  3.92286478e-01  2.22044605e-14 -9.79899427e+00
#    2.22044605e-14  0.00000000e+00 -1.38851585e+00  6.19628233e-01]
#  [ 0.00000000e+00  0.00000000e+00  0.00000000e+00 -1.89369528e-01
#   -8.51679834e-01  4.07039158e-03  8.49119228e+00 -6.80517438e-02
#    0.00000000e+00  1.42257772e+00  0.00000000e+00 -2.73465947e+01]
#  [ 0.00000000e+00  0.00000000e+00  0.00000000e+00 -4.41741693e-01
#   -2.46890492e-02 -4.89162969e+00 -4.89193391e+00 -1.19498434e-01
...
#  [ 0.00000000e+00  0.00000000e+00  0.00000000e+00  1.22909150e-01
#   -4.23482873e+00  6.41465012e-03  0.00000000e+00  0.00000000e+00
...
#  [ 0.00000000e+00  0.00000000e+00  0.00000000e+00  1.02442961e-02
#    8.58419490e-01  5.34772009e-04  0.00000000e+00  0.00000000e+00
