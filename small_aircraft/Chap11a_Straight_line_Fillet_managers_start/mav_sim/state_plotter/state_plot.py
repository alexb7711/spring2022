...
class StatePlot():
    ...
    def add_state(self, name: str, sigma_bounds: Optional[list[int]]=None, max_length: Optional[int] =None,
...
def get_ellipse(center: Union[list[int], list[float], tuple[int, int], tuple[float, float]],
    radius: Union[int, float, list[int], list[float]]) -> npt.NDArray[Any]:
