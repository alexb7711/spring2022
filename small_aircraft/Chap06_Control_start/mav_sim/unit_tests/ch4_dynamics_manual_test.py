"""dynamics_test.py Tests the dynamics for known parameters
"""
...
T_p, Q_p = motor_thrust_torque(mav._Va, delta.throttle)
print("Propeller Forces and Torque", "\n")
print("T_p: " , T_p)
print("Q_p: " , Q_p, "\n\n")

forcesAndMoments = forces_moments(mav._state, delta, mav._Va, mav._beta, mav._alpha)
...
x_dot = derivatives(mav._state, forcesAndMoments)
...
mav._state = types.DynamicState(  np.array([[ 6.19506532e+01],
 [ 2.22940203e+01],
 [-1.10837551e+02],
 [ 2.73465947e+01],
 [ 6.19628233e-01],
...
current_wind = types.WindVector( np.array([[ 0.        ],
 [ 0.        ],
 [ 0.        ],
 [-0.00165177],
 [-0.00475441],
...
(mav._Va, mav._alpha, mav._beta, _) = update_velocity_data(mav._state, current_wind)
print("Wind Update" , "\n")
print("Va: ", mav._Va)
...
# fx:  37.00037827556278
# fy:  54.08547824660243
# fz:  46.87736137811242
...
# north_dot:  24.283238643486623
# east_dot:  12.605130052025968
# down_dot:  1.2957327060769264
#    u_dot:  3.230081136537419
#    v_dot:  0.22588559134330044
#    w_dot:  8.872842913968224
...
# fx:  36.22902428474341
# fy:  48.38801210813696
# fz:  -39.48804902070229
# Mx:  0.10925814573797177
# My:  0.1249623335264915
# Mz:  -0.09513777456448343
...
#    v_dot:  -0.28711747050966263
#    w_dot:  1.0301313371736271
#   e0_dot:  -0.025995661302161892
#   e1_dot:  -0.011500703223228347
#   e2_dot:  0.05851804333262313
#   e3_dot:  0.10134276693843723
#    p_dot:  0.10353614217633975
#    q_dot:  0.11393277483867911
#     r_dt:  -0.04913225070552518
